...
public class BezelImageView extends AppCompatImageView {
    ...
    public BezelImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ccv_BezelImageView,
                defStyle, 0);

        mMaskDrawable = a.getDrawable(R.styleable.ccv_BezelImageView_ccv_mask_drawable);
        if (mMaskDrawable != null) {
            mMaskDrawable.setCallback(this);
        }

        mBorderDrawable = a.getDrawable(R.styleable.ccv_BezelImageView_ccv_border_drawable);
        if (mBorderDrawable != null) {
            mBorderDrawable.setCallback(this);
        }

        mDesaturateOnPress = a.getBoolean(R.styleable.ccv_BezelImageView_ccv_desaturate_on_press,
                mDesaturateOnPress);
